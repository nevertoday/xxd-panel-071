...
```text
/xxd-panel-071 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，071 设计在下）
2. 左右对照（原图在左，071 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-071/<fresh-task>/
...
- `references/xxd-panel-071-prompt.zh-CN.md`
- `references/xxd-panel-071-prompt.en.md`
